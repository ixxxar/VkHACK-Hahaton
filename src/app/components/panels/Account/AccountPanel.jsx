    ...
    <Panel id={id}>
      ...
      <div className="account_panel">
        <div className="account_left">
          ...
          <Title level="1" style={{ marginTop: "20px", marginBottom: "20px" }}>
            Игорь, 16
          </Title>
          <div className="portfolio_block">
            <Text className="portfloio_text">Порфтолио</Text>
          </div>
        ...
        <div className="account_right">
          <div className="about_block">
            <Headline level="1" style={{ color: "#7F8285", marginBottom: 12 }}>
              О себе
            </Headline>
            <Title level="3" className="about_title">
              Люблю лягушек и вок, ок?
            </Title>
          </div>
          ...
          <div className="specialization_block" style={{ marginBottom: 17 }}>
            ...
            <div className="spec_plates">
              <div className="default_plate">Программирование</div>
              <div className="default_plate">Программирование</div>
            </div>
          </div>
          <div className="specialization_block" style={{ marginBottom: 20 }}>
            ...
            <div className="spec_plates">
              <div className="default_plate">Python</div>
              <div className="default_plate">C#</div>
            </div>
          </div>
          <Headline
            level="1"
          ...
          <Title style={{ marginBottom: 12, marginLeft: "5%" }}>4</Title>
          <div className="btn_container">
            <Button className="edit_button">Редактировать анкету</Button>
          </div>
        </div>
      </div>
    </Panel>
